...
function NavBar() {
  ...
  return (   
      <header className={`App-header  ${darkTheme ? 'dark-mode' : '' }`}>
          ...
          <ul className="navBar">   
              <SwitchTheme/>
              <li><Button variant="outlined" color="error" sx={{ mb: 1}}
               onClick={pageHome} className={`btnNavBar ${darkTheme ? 'dark-mode' : '' }`} >Inicio</Button></li>              
              ...
              <li><Button variant="outlined" color="error" sx={{ mb: 1}}
               onClick={pageNosotros} className={`btnNavBar ${darkTheme ? 'dark-mode' : '' }`}>Nosotros</Button></li>
              <li><Button variant="outlined" color="error" sx={{ mb: 1}} 
              onClick={pageContacto} className={`btnNavBar ${darkTheme ? 'dark-mode' : '' }`} >Contacto</Button></li>           
              <li>
